...
class AttentionUNet3D(nn.Module):
    def __init__(self, channel_factor=1, img_channel=2, output_channel=1):
        super(AttentionUNet3D, self).__init__()

        n = 16 * channel_factor
        channels = [n, n*2, n*4, n*8]
    ...
    def forward(self, img, sex, age):
        ...
        segmentation = self.seg(level1_Conv_out)
...
class AttentionUNet3D_seg(nn.Module):
    def __init__(self, channel_factor=1, img_channel=2, output_channel=1):
        super(AttentionUNet3D, self).__init__()
...
# AttentionUNet3D_cls == UNet3D_cls
class AttentionUNet3D_cls(nn.Module):
    def __init__(self, channel_factor=1, img_channel=2, output_channel=1):
        super(AttentionUNet3D, self).__init__()
