...
class VNet(nn.Module):
    ...
    def __init__(self, inChans=1, depth=4):
        ...
        if self.depth == 3:
            ...
            self.down_layer4 = DownLayer(inChans=64, nConvs=3)
        if self.depth == 4:
            self.down_layer3 = DownLayer(inChans=32, nConvs=2)
            self.up_layer3 = UpLayer(inChans=256, nConvs=2)
            self.down_layer4 = DownLayer(inChans=64, nConvs=3)
            self.up_layer4 = UpLayer(inChans=256, nConvs=3, depthest_layer=True)
            self.down_layer5 = DownLayer(inChans=128, nConvs=3)
